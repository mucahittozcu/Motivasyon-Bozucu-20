...
export default function App() {
  ...
  // // hydrateData işlevi, currentData boşsa getNextData işlevini çağırır ve bu işlev rastgele bir alıntı ve görseli döndürür.
  ...
  // // getNextData işlevi, quoteData ve imageData adında iki veri kaynağından rastgele bir alıntı ve görsel çifti seçer.
  ...
  // // getNextQuote işlevi, kullanıcının bir sonraki alıntı ve görseli görmek için tıkladığı zaman çalışır. Bu işlev, bir sonraki alıntı ve görseli setCurrentData işleviyle ayarlar.
...
// // JSX içinde, currentData ve currentData.image varsa, <div className='wrapper'> ve <div className='quote-container'> öğelerine sırasıyla alıntı ve görsel için stiller uygulanır. Ayrıca, alıntının font boyutu, getSmallestFontSize işlevi kullanılarak belirlenir.

// // <NextQuoteButton> bileşeni, kullanıcının bir sonraki alıntıyı görmek için tıkladığı bir düğmedir.
  return (
    <>
